                        ...
                        <form>
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn" type="submit" id="button-addon2"><img src="/admin/images/svg-icon/search.svg" class="img-fluid" alt="search"></button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown notifications-menu">
                    <a href="#" class="waves-effect waves-light dropdown-toggle" data-toggle="dropdown" title="Notifications">
                        <img src="/admin/images/svg-icon/notifications.svg" class="img-fluid svg-icon" alt="">
                    </a>
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="waves-effect waves-light dropdown-toggle" data-toggle="dropdown" title="User">
                        <img src="/admin/images/svg-icon/user.svg" class="rounded svg-icon" alt="" />
                    </a>
